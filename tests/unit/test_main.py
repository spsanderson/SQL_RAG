...
def test_main(
    mock_print, mock_input, mock_orchestrator, mock_retriever, mock_vector_store,
    mock_embedding, mock_parser, mock_prompt, mock_ollama, mock_executor,
    mock_pool, mock_load_config, mock_setup_logging
):
    """Test main function with successful query processing."""
    # Setup mocks
...
def test_main_config_error(mock_print, mock_load_config, mock_setup_logging):
    """Test main function handling of configuration errors."""
